...
export default function BasicExample() {
  ...
  return (
    <div className="container py-8 md:py-10 max-w-5xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1] mb-3">Basic Autofill Example</h1>
          ...
          <Card>
            ...
            <CardContent>
              <pre className="text-xs overflow-x-auto bg-slate-950 text-slate-50 p-4 rounded-md">
                <code>{`import { useForm } from 'react-hook-form-ai';
