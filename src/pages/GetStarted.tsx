            ...
            <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <Button variant="link" className="h-auto p-0">
                      <a href="/examples/basic">Basic Autofill Example</a>
                    </Button>
                  </li>
                  <li>
                    <Button variant="link" className="h-auto p-0">
                      <a href="/examples/field-suggestions">Field Suggestions</a>
                    </Button>
                  </li>
                  <li>
                    <Button variant="link" className="h-auto p-0">
                      <a href="/examples/multi-provider">Multi-Provider Setup</a>
                    </Button>
                  </li>
                  <li>
                    <Button variant="link" className="h-auto p-0">
                      <a href="/examples/chrome-ai">Chrome AI Download Handling</a>
                    </Button>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Button variant="link" className="h-auto p-0">
                      <a href="https://github.com/grayhatdevelopers/react-hook-form-ai" target="_blank" rel="noopener noreferrer">
                        GitHub Repository
                      </a>
                    </Button>
                  </li>
                  <li>
                    <Button variant="link" className="h-auto p-0">
                      <a href="https://www.npmjs.com/package/react-hook-form-ai" target="_blank" rel="noopener noreferrer">
                        NPM Package
                      </a>
                    </Button>
                  </li>
